      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="<?php if($active == 'Data Surat Tugas') {echo 'active';}?>"><a href="<?php echo base_url('Prodi/suratList'); ?>"> <i class="menu-icon ti-file"></i>Data Surat Tugas </a></li>
            <li class="<?php if($active == 'Data Dosen') {echo 'active';}?>"><a href="<?php echo base_url('Prodi/dosenList'); ?>"> <i class="menu-icon fa fa-users"></i>Data Dosen </a></li>
