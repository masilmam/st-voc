      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?php echo base_url('Dekan/dashboard'); ?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a></li>
            <li><a href="<?php echo base_url('Dekan/suratList'); ?>"> <i class="menu-icon ti-file"></i>Data Surat Tugas</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <strong class="card-title">Daftar Permohonan Surat Tugas: Butuh Tindakan Oleh Dekan</strong>
                </div>
                <div class="card-body">
