      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo base_url('Dekan/dashboard'); ?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a></li>
            <li class="active"><a href="<?php echo base_url('Dekan/suratList'); ?>"> <i class="menu-icon ti-file"></i>Data Surat Tugas</a></li>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('Dekan/doAddDisposisi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                  <select name="disposisi" id="disposisi" class="form-control" required>
                    ...
                    <option value="Dari Dekan ke Wakil Dekan I">Wakil Dekan I</option>
                    <option value="Dari Dekan ke Wakil Dekan II">Wakil Dekan II</option>
                  </select>
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="datepicker" name="batas_waktu" autocomplete="off" class="form-control" value="<?php echo set_value('batas_waktu'); ?>" required><small><?php echo form_error('batas_waktu'); ?></small></div>
              </div>
          </div>
