      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo base_url('Wadek1/dashboard'); ?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a></li>
            <li class="active"><a href="<?php echo base_url('Wadek1/suratList'); ?>"> <i class="menu-icon ti-file"></i>Data Surat Tugas</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="col-md-12">
                    <a href="<?php echo base_url('Wadek1/dokumen/').$suratDetail->dokumen; ?>" class="btn btn-warning" style="color:#fff"><i class="fa fa-paperclip"></i>&nbsp; Lihat Berkas</a>&nbsp;
                    <?php
                      if ($suratDetail->status == 2) {
                    ?>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('Wadek1/doAddDisposisi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                  <select name="disposisi" id="disposisi" class="form-control" required>
                    ...
                    <option value="Dari Wakil Dekan I ke Kepala Tata Usaha">Kepala Tata Usaha</option>
                  </select>
