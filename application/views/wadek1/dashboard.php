      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?php echo base_url('Wadek1/dashboard'); ?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a></li>
            <li><a href="<?php echo base_url('Wadek1/suratList'); ?>"> <i class="menu-icon ti-file"></i>Data Surat Tugas</a></li>
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <strong class="card-title">Daftar Permohonan Surat Tugas: Butuh Tindakan Oleh Wakil Dekan I</strong>
                </div>
                <div class="card-body">
                  <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo base_url('Wadek1/suratDetail/').$s->id_surat; ?>" class="btn btn-secondary btn-sm btn-block" style="color: #ffffff;"><i class="fa fa-external-link"></i>&nbsp; Detail<a/></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
