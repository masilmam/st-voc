    ...
    <div id="right-panel" class="right-panel">
      ...
      <div class="content mt-3">
        ...
        <div class="animated fadeIn">
          <div class="row">
            <div class="col-md-12">
              <h3>Edit Program Studi</h3><br />
              <div class="card">
                <div class="card-body">
                  <form action="<?php echo base_url('Fakultas/doEditProdi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <input type="hidden" name="id_prodi" value="<?php echo $prodiDetail->id_prodi; ?>">
                    <div class="row form-group">
                      <div class="col col-md-3"><label for="id_departemen" class=" form-control-label">Departemen</label></div>
                      <div class="col-12 col-md-9"><input type="text" id="id_departemen" name="id_departemen" value="<?php echo $prodiDetail->nama_departemen; ?>" class="form-control" readonly><small><?php echo form_error('id_departemen'); ?></small></div>
                    </div>
                    <div class="row form-group">
                      <div class="col col-md-3"><label for="nama_prodi" class=" form-control-label">Nama Program Studi</label></div>
                      <div class="col-12 col-md-9"><input type="text" id="nama_prodi" name="nama_prodi" value="<?php echo $prodiDetail->nama_prodi; ?>" class="form-control" required><small><?php echo form_error('nama_prodi'); ?></small></div>
                    </div>
