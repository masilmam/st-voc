...
<head>
    ...
    <title>Data User Program Studi</title>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
              ...
              <li class="active"><a href="<?php echo base_url('Fakultas/userProdiList'); ?>"> <i class="menu-icon ti-user"></i>Data User Program Studi</a></li>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <div class="content mt-3">
        ...
        <div class="animated fadeIn">
          <div class="row">
            <div class="col-md-12">
              <h3>Data User Program Studi&nbsp;<a data-target="#tambah" data-toggle="modal" href="#tambah" class="fa fa-plus-circle"></a></h3><br />
              <div class="card">
                <div class="card-body">
                  <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url('Fakultas/resetPassword/').$u->id_user; ?>" class="btn btn-warning btn-sm" style="color:#ffffff;" onclick="return confirm('Apakah Anda yakin? Password akan direset menjadi : qwerty1234');"><i class="fa fa-refresh"></i>&nbsp; Reset</a>
                          <a href="<?php echo base_url('Fakultas/deleteUser/').$u->id_user; ?>" class="btn btn-danger btn-sm" style="color:#ffffff;" onclick="return confirm('Apakah Anda yakin?');"><i class="fa fa-trash"></i>&nbsp; Hapus</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="tambah">Tambah User Program Studi</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="<?php echo base_url('Fakultas/doAddUserProdi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col col-md-3"><label for="select" class=" form-control-label">Pilih Program Studi</label></div>
